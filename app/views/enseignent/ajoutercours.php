...
<div class="bg-gray-100 flex justify-center items-center min-h-screen m-0 ">
    <form action="/validerajout" method="POST" id="addCategoryForm">
        <div class="max-w-[900px] w-full bg-white rounded-lg shadow-lg overflow-y-scroll ">
            ...
            <div class="px-8 py-6">
                ...
                <div class="flex justify-between mt-8">
                    <a href="/encourses" class="text-white bg-red-600 w-40 rounded-lg py-3 hover:bg-red-800 cursor-pointer flex justify-center">
                        Annuler
                    </a>
