...
<body>
    ...
    <nav class="bg-white mb-8 rounded-xl shadow-lg overflow-hidden transition-all hover:shadow-2xl hover:-translate-y-1">
      ...
      <div class="flex justify-end items-center m-5">
        <a href="/ajoutercours" class="pt-1 text-white bg-purple-600 rounded-lg w-56 h-10 text-lg font-bold hover:bg-purple-700 transition-colors inline-block text-center">
            Ajouter Cours
        </a>
    </div>
        ...
        <?php foreach ($cours as $coursItem): ?>
            <div class="bg-white rounded-xl shadow-lg overflow-hidden transition-all hover:shadow-2xl hover:-translate-y-1">
                ...
                <div class="p-6">
                    ...
                    <a href="/modifie/<?php echo $coursItem->getIdCours(); ?>">
